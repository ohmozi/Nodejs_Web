...
module.exports = {
  HTML: function (title, db_list, body, control, author_list, authStatusUI = '<a href="/login/login">login</a>'){
    return `
    <!doctype html>
    <html>
    <head>
    ...
    <body>
      ...
      ${authStatusUI}
      <h1><a href="/">WEB</a></h1>
      <p><a href="/author/author_list">author</a></p>
      ${db_list}
      ${control}
      ${body}
      ${author_list}
    ...
    */
    ...
    while(i < authors.length){
      ...
      <tr>
        ...
        <td>
          <form action="/author/process_author_delete" method="post" onsubmit="delete()">
